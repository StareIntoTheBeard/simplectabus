...
Stop IDs are gleaned from the getStops api at the moment. Javascript refreshes the browser every minute.
...
=== Changelog
v1.1.1 - Fixed a bug where times retrieved at wasn't updating when ajax call occurred.
